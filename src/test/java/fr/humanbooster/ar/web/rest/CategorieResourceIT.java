...
public class CategorieResourceIT {
    ...
    private static final Float DEFAULT_PRIX_EN_EUROS = 1F;
    private static final Float UPDATED_PRIX_EN_EUROS = 2F;
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .nom(DEFAULT_NOM)
            .prixEnEuros(DEFAULT_PRIX_EN_EUROS);
        return categorie;
    }
    /**
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie()
            .nom(UPDATED_NOM)
            .prixEnEuros(UPDATED_PRIX_EN_EUROS);
        return categorie;
    }
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getPrixEnEuros()).isEqualTo(DEFAULT_PRIX_EN_EUROS);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].prixEnEuros").value(hasItem(DEFAULT_PRIX_EN_EUROS.doubleValue())));
    }
    ...
    public void getCategorie() throws Exception {
        ...
        restCategorieMockMvc.perform(get("/api/categories/{id}", categorie.getId()))
            ...
            .andExpect(jsonPath("$.prixEnEuros").value(DEFAULT_PRIX_EN_EUROS.doubleValue()));
    }
    @Test
    @Transactional
    ...
    public void updateCategorie() throws Exception {
        ...
        assertThat(testCategorie.getPrixEnEuros()).isEqualTo(UPDATED_PRIX_EN_EUROS);
    }
